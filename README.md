...
> ❗ **IMPORTANT**: This extension has been deprecated in favor of the [WSO2 Integrator: SI](https://marketplace.visualstudio.com/items?itemName=WSO2.streaming-integrator) extension. Please install the WSO2 Integrator: SI extension instead.
