...
import { SetupDetails, SetPathRequest, PathDetailsResponse, OpenExternalRequest, OpenExternalResponse, DownloadSIRequest } from "./types";

export interface SIVisualizerAPI {
