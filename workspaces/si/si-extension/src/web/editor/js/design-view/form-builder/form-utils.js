...
define(['require', 'lodash', 'appData', 'log', 'constants', 'handlebar', 'annotationObject', 'annotationElement',
        ...
        'queryOutputDelete', 'queryOutputUpdate', 'queryOutputUpdateOrInsertInto', 'perfect_scrollbar', 'cronstrue', 'cronGenerator', 'js_tree'],
    function (require, _, AppData, log, Constants, Handlebars, AnnotationObject, AnnotationElement, DesignViewUtils,
              ...
              QueryOutputUpdate, QueryOutputUpdateOrInsertInto, PerfectScrollbar, Cronstrue, CronGenerator, jsTree) {
        ...
        FormUtils.prototype.addEventListenersForJstree = function (tree) {
                ...
                tree.create_node(selectedNode,
                    {
                        ...
                        "a_attr": {"class": "annotation-key"}, icon: `${extensionPath}/editor/commons/images/properties.png`,
                        children: [{
                            text: "value", class: "annotation-value", "a_attr": {"class": "annotation-value"},
                            icon: `${extensionPath}/editor/commons/images/value.png`
                        }]
                    }
                );
            ...
            $("#btn-add-annotation").on("click", function () {
                ...
                tree.create_node(selectedNode, {
                    ...
                    "a_attr": {"class": "annotation"}, icon: `${extensionPath}/editor/commons/images/annotation.png`,
                    children: [{
                        text: "property", class: "annotation-key", icon: `${extensionPath}/editor/commons/images/properties.png`,
        ...
        FormUtils.prototype.getTooltip = function (element, type) {
            ...
            var self = this;
            var result = '';
            self.tooltipsURL = 'http://localhost:3000' + "/editor/tooltips";
            $.ajax({
                type: "POST",
