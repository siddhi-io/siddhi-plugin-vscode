...
define(['require', 'log', 'lodash', 'jquery', 'tool_palette/tool-palette', 'designViewGrid', 'appData',
    ...
    function (require, log, _, $, ToolPalette, DesignViewGrid, AppData, InitialiseData, JSONValidator) {
        ...
        DesignView.prototype.renderDesignGrid = function (configurationJSON) {
            var self = this;
            self.application.designView = self;
        ...
        DesignView.prototype.getDesign = async function () {
            // Add message listener globally
            ...
            if (match !== null) {
                ...
                self.codeToDesignURL = 'http://localhost:3000' + "/editor/design-view";
                $.ajax({
                    type: "POST",
        ...
        DesignView.prototype.getCode = function (designViewJSON) {
            var self = this;
            var result = {};
            self.designToCodeURL = 'http://localhost:3000' + "/editor/code-view";
            $.ajax({
                type: "POST",
