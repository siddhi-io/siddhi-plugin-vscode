...
define(['require', 'log', 'jquery', 'backbone', 'tool_palette/tool', 'tool_palette/tool-view'],
    function (require, log, $, Backbone, Tool, ToolView) {
        ...
        var ToolPalette = Backbone.View.extend({
                ...
                var definitionTools = [
                    {
                        ...
                        title: "Stream",
                        icon: `${extensionPath}/editor/images/streams.svg`,
                    ...
                    },
                    {
                        ...
                        title: "Source",
                        icon: `${extensionPath}/editor/images/source.svg`,
                        toolGroupName: "I/O"
                    },
                    {
                        id: "sink",
                        className: "sink-drag",
                        title: "Sink",
                        icon: `${extensionPath}/editor/images/sink.svg`,
                        toolGroupName: "I/O"
                    },
                    {
                        id: "table",
                        ...
                        title: "Table",
                        icon: `${extensionPath}/editor/images/table.svg`,
                    ...
                    },
                    {
                        ...
                        title: "Window",
                        icon: `${extensionPath}/editor/images/window.svg`,
                        toolGroupName: "Collections"
                    },
                    {
                        id: "trigger",
                        ...
                        title: "Trigger",
                        icon: `${extensionPath}/editor/images/trigger.svg`,
                        toolGroupName: "Flow Constructs"
                    },
                    {
                        id: "aggregation",
                        ...
                        title: "Aggregation",
                        icon: `${extensionPath}/editor/images/aggregate.svg`,
                        toolGroupName: "Collections"
                    },
                    {
                        id: "projection-query",
                        ...
                        title: "Projection",
                        icon: `${extensionPath}/editor/images/query.svg`,
                    ...
                    },
                    {
                        ...
                        title: "Filter",
                        icon: `${extensionPath}/editor/images/filter-query.svg`,
                        toolGroupName: "Queries"
                    },
                    {
                        id: "window-query",
                        ...
                        title: "Window",
                        icon: `${extensionPath}/editor/images/window-query.svg`,
                        toolGroupName: "Queries"
                    },
                    {
                        id: "function-query",
                        ...
                        title: "Function",
                        icon: `${extensionPath}/editor/images/function-query.svg`,
                        toolGroupName: "Queries"
                    },
                    {
                        id: "join-query",
                        ...
                        title: "Join",
                        icon: `${extensionPath}/editor/images/join-query.svg`,
                        toolGroupName: "Queries"
                    },
                    {
                        id: "pattern-query",
                        ...
                        title: "Pattern",
                        icon: `${extensionPath}/editor/images/pattern-query.svg`,
                        toolGroupName: "Queries"
                    },
                    {
                        id: "sequence-query",
                        ...
                        title: "Sequence",
                        icon: `${extensionPath}/editor/images/sequence-query.svg`,
                        toolGroupName: "Queries"
                    },
                    {
                        id: "partition",
                        ...
                        title: "Partition",
                        icon: `${extensionPath}/editor/images/partition.svg`,
                        toolGroupName: "Flow Constructs"
                    },
                    {
                        id: "function",
                        ...
                        title: "Function",
                        icon: `${extensionPath}/editor/images/function.svg`,
            ...
            render: function () {
                console.log("render tool-palette")
                var self = this;
