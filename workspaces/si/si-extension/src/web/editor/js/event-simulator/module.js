 ...
 */
define(['jquery', 'backbone', 'lodash', 'log', './simulator', './feed_simulator'],
    function ($, Backbone, _, log, singleEventSimulator, feedSimulator) {
        var EventSimulator = Backbone.View.extend({
            initialize: function (config, vscode) {
                var errMsg;
                var self = this;
                this.vscode = vscode;
                this._breakPoints = {};
            ...
            renderContent: function () {
                ...
                singleEventSimulator.init(this._options, this.vscode);
                feedSimulator.init(this._options, this.vscode);
