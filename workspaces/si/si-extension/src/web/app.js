...
requirejs.config({
    ...
    paths: {
        ...
        // query sub elements
        querySelect: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-select/query-select`,
        queryOrderByValue: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-orderBy/query-orderBy-value`,
        queryOutput: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-output/query-output`,
        queryOutputInsert: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-output/query-output-types/query-output-insert`,
        queryOutputDelete: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-output/query-output-types/query-output-delete`,
        queryOutputUpdate: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-output/query-output-types/query-output-update`,
        queryOutputUpdateOrInsertInto: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-output/query-output-types/query-output-update-or-insert-into`,
        // queries
        joinQuerySource: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-input/join-query-input/sub-elems/join-query-source`,
        joinQueryInput: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-input/join-query-input/join-query-input`,
        ...
        patternOrSequenceQueryInput: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-input/pat-seq-query-input/pat-seq-query-input`,
        patternOrSequenceQueryCondition: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-input/pat-seq-query-input/sub-elems/pat-seq-query-condition`,
        windowFilterProjectionQueryInput: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-input/win-filter-proj-query/window-filter-projection-query-input`,
        queryWindowOrFunction: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-input/query-window-or-function`,
        streamHandler: `${extensionPath}/editor/js/design-view/elements/queries/query-sub-elems/query-input/stream-handler`,
